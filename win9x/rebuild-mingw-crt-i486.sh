...
# -march at all.
#
# Passing -march=i486 to OUR OWN code (see DEFINES in this repo's
# win9x/Makefile) fixes our object files, but not Ubuntu's
...
# `make` in this repo -- and in the sibling AmuletsArmor/AAServer/
# AAScriptCompiler repos, which each carry their own copy of this same
# script. Safe to re-run; takes a few minutes.
set -euo pipefail
